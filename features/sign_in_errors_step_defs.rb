...
Then 'error {string} is shown' do |text_string|
  ...
  # I could make this step definition more generic and not
  # specific to errors. From my previous experience with
  # Cucumber, it can make the difficult of debug when you
  # have many 100's of step definitions. Not everyone is
  # good at naming their step definitions. Use Gherkin if
  # you want that sort syntax.
